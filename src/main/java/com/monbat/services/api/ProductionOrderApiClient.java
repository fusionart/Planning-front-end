...
public class ProductionOrderApiClient {
    ...
    public static List<ProductionOrder> getData(LocalDate reqDelDateBegin, LocalDate reqDelDateEnd) {
        ...
        try {
            ...
            ResponseEntity<List<ProductionOrder>> response = restTemplate.exchange(
                    builder.toUriString(),
                    HttpMethod.GET,
                    null,
            ...
            LoggerFactory.getLogger(ProductionOrderApiClient.class).error("Error fetching production orders", e);
